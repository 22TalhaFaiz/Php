...
<div class="header">
	<div class="header-top">
		...
		<?php }else{?><a href="login.php">Login</a> 
			<a href="registration.php">&nbsp;&nbsp; &nbsp;Register</a><?php }?></li>
			        </ul>
			  </div>
 			<div class="clear"></div>
...
<div class="block">
	<div class="wrap">
        ...
        <input type="text" placeholder="Enter A Movie Name" style=" border-radius:15px;   height:30px;width:250px" 
		 required id="search111" name="search">&nbsp;&nbsp;&nbsp;
                                
        <input type="submit" value="Search" style="height:33px; border-radius:15px;" id="button111">
    </div>       	
