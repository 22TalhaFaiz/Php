...
if(!isset($_SESSION['user_id'])){
    ...
    include("header.php");
    include("../config.php");
    $query = "SELECT * FROM showtime s INNER JOIN movies m ON s.movie_id = m.id INNER JOIN theater t ON s.Theater_id = t.id";
...
<tbody>
    ...
    <tr>
        ...
        <td><?php echo $data["Theater_id"]; ?></td>
        <td><?php echo $data["showdatetime"]; ?></td>
        <td><?php echo $data["Class"]; ?></td>
        <td><?php echo $data["Rates"]; ?></td>
